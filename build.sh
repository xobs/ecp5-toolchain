...
win_nextpnr_url="https://github.com/xobs/toolchain-nextpnr-ecp5/releases/download/v1.2-fomu/nextpnr-ecp5-windows_amd64-v1.2-fomu.zip"
...
mac_nextpnr_url="https://github.com/xobs/toolchain-nextpnr-ecp5/releases/download/v1.2-fomu/nextpnr-ecp5-darwin-v1.2-fomu.tar.gz"
...
linux_nextpnr_url="https://github.com/xobs/toolchain-nextpnr-ecp5/releases/download/v1.2-fomu/nextpnr-ecp5-linux_x86_64-v1.2-fomu.tar.gz"
